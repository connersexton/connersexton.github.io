...
When rotated, the factor loadings for our EFA model showed much clearer correlations between each of the 13 effects and the 5 common factors. For example, "Focused" shows a strong, positive correlation with factor 2, "Hungry" shows a strong, positive correlation with factor 3, and "Energetic" shows a moderate, negative correlation with factor 1 (to name a few...).
