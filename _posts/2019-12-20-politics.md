...
- [x] Set text to lowercase

- [x] Remove numbers

- [x] Remove stopwords (e.g. “a”, “and”, “but”, etc.)

- [x] Remove punctuation

- [x] Strip unnecessary white spaces

- [x] Stem the words (“learning” or “learned” => “learn”)
...
![alt]({{ site.url }}{{ site.baseurl }}/images/partywordcloud.png)
